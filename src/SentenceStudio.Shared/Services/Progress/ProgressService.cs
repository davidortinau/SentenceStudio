...
public class ProgressService : IProgressService
{
    ...
    public Task<List<ActivityLogWeek>> GetActivityLogAsync(DateTime fromUtc, DateTime toUtc, ActivityCategory? filter = null, CancellationToken ct = default)
        => _activityLogService.GetActivityLogAsync(fromUtc, toUtc, filter, ct);
}
